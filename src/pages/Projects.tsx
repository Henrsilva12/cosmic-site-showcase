      ...
      <main className="flex-grow py-8 mt-32">
        <div className="container mx-auto px-4">
          ...
          <p 
            ...
            data-aos-delay="100"
          >
            Nesta seção, você encontra uma coletânea dos projetos desenvolvidos ao longo do curso de 
            Sistemas de Informação do IF Baiano – Campus Itapetinga. São iniciativas que unem teoria 
            e prática, explorando áreas como tecnologia, inovação, redes, robótica, sustentabilidade, 
            programação e muito mais. Clique em cada projeto para conhecer mais detalhes sobre as 
