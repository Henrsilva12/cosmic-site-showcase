...
const AboutSection = () => {
  return <section className="py-16">
      <div className="container mx-auto px-4 mb-12">
        <h2 className="text-4xl font-bold text-center text-foreground font-heading">Sobre</h2>
      </div>
        ...
        <Card className="bg-section-gradient rounded-[20px] overflow-hidden shadow-2xl">
          <CardContent className="p-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="relative overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 rounded-[12px]">
